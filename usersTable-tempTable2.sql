...
SELECT * FROM #resultsTable  where r_lcdate = '02-27-2013' AND r_agentid = 'rnx' 

SELECT * FROM #statsTable where s_dialdate = '02-27-2013' AND s_agent = 'rnx'

SELECT * FROM stats where dialdate = '02-27-2013' AND agent = 'rnx'

SELECT * FROM results_NRF where lcdate = '02-27-2013' AND agentid = 'rnx' and s__amount !='0.00'
